      ...
      <div className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center mb-6">
            <div className="bg-gray-100 text-gray-700 text-sm px-4 py-2 rounded-full flex items-center gap-2">
          ...
          <div className="text-center mb-28">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              <motion.button
                ...
                className="bg-gray-800 text-white px-10 py-3 rounded-full hover:opacity-80 transition shadow-md"
              >
                Start Interview
              </motion.button>
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.05 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className="border border-gray-200 px-10 py-3 rounded-full hover:bg-gray-300 transition"
              >
                View History
              </motion.button>
            </div>
